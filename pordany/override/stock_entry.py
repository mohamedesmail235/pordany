...
from pordany.pordany.doctype.batch.batch import get_batch_no, get_batch_qty, set_batch_nos
from erpnext.stock.doctype.item.item import get_item_defaults
from pordany.pordany.doctype.serial_no.serial_no import (
	get_serial_nos,
...
from pordany.get_item_details import (
	get_barcode_data,
	get_bin_details,
...
class CustomStockEntry(StockController):
	...
	def get_item_details(self, args=None, for_update=False):
		...
		barcode_data = get_barcode_data(items_list=[item])
